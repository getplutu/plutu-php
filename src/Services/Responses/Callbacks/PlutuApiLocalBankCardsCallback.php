...
/**
 * This class represents the callback received from the Plutu API for a local bank cards transaction.
 */
class PlutuApiLocalBankCardsCallback extends PlutuApiCallback
{
    /**
