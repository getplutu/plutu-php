...
namespace PlutuTests\Unit\Services\PlutuLocalBankCards;
...
/**
 * Test case for the PlutuLocalBankCards::confirm() method.
 *
 * @group PlutuLocalBankCards
 */
class ConfirmTest extends PlutuTest
{
    ...
    /**
     * Builds a request to confirm a Local Bank Cards payment.
     *
    ...
    private function tryTestWithRequest(mixed $amount = null, mixed $invoiceNo = null, mixed $returnUrl = null): void
    {
        ...
        $api = new PlutuLocalBankCards($this->httpClientMock);
